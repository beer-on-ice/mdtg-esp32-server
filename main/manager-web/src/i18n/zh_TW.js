export default {
	...
	'firmwareDialog.uploadHint': '溫馨提示：請上傳合併前的xiaomai.bin文件，而不是合併後的merged-binary.bin文件',
	...
	'paramManagement.updateSuccess': '修改成功，部分配置需重啟xiaomai-server模組才生效',
	...
	'modelConfig.setDefaultSuccess': '設置默認模型成功，請及時手動重啟xiaomai-server模組',

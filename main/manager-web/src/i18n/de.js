export default {
	...
	'mcpToolCall.help.getDeviceStatus':
		'Aktuellen Betriebsstatus des Geräts anzeigen, einschließlich Lautstärke, Bildschirm, Batterie und anderen Informationen.',
	...
	'mcpToolCall.help.setBrightness':
		'Helligkeit des Gerätebildschirms anpassen, bitte einen Wert zwischen 0-100 eingeben.',
	...
	'mcpToolCall.help.takePhoto':
		'Fotos mit der Gerätekamera aufnehmen und Erkennungsanalyse durchführen, bitte geben Sie Ihre Frage ein.',
	'mcpToolCall.help.getSystemInfo':
		'Systeminformationen des Geräts abrufen, einschließlich Hardwarespezifikationen, Softwareversion etc.',
	'mcpToolCall.help.reboot': 'Gerät neu starten, das Gerät wird nach Ausführung neu gestartet.',
	'mcpToolCall.help.upgradeFirmware':
		'Gerätefirmware von der angegebenen URL herunterladen und aktualisieren, das Gerät startet nach der Aktualisierung automatisch neu.',
	'mcpToolCall.help.getScreenInfo':
		'Detaillierte Informationen zum Bildschirm abrufen, wie Auflösung, Größe und andere Parameter.',
	...
	'device.verificationCodePlaceholder':
		'Bitte den 6-stelligen Bestätigungscode eingeben, der vom Gerät gesendet wird..',
	...
	'cache.swDevEnvWarning':
		'In Entwicklungsumgebung kann Service Worker Cache möglicherweise nicht korrekt initialisieren',
	...
	'cache.swCheckMethod3':
		'Produktions-Build (npm run build) verwenden und über HTTP-Server aufrufen, um volle Funktionalität zu testen',
	...
	'cache.swNotSupported':
		'Der aktuelle Browser unterstützt Service Worker nicht, CDN-Ressourcen-Caching-Funktion nicht verfügbar',
	...
	'cache.noCachedResourcesDesc':
		'Service Worker hat möglicherweise die Initialisierung nicht abgeschlossen oder Cache wurde noch nicht eingerichtet. Bitte Seite aktualisieren oder später erneut versuchen.',
	...
	'dictManagement.confirmBatchDeleteDictData':
		'Sind Sie sicher, dass Sie {count} ausgewählte Wörterbuchdaten löschen möchten?',
	...
	'user.resetPasswordSuccess':
		'Passwort wurde zurückgesetzt, bitte benachrichtigen Sie den Benutzer, sich mit dem neuen Passwort anzumelden',
	...
	'roleConfig.restartNotice':
		'Nach dem Speichern der Konfiguration müssen Sie das Gerät neu starten, damit die neue Konfiguration wirksam wird.',
	...
	'functionDialog.pleaseSelectFunctionForParam':
		'Bitte wählen Sie eine konfigurierte Funktion für Parametereinstellungen aus',
	...
	'modelConfigDialog.invalidModelId':
		'Modell-ID darf nicht nur aus Text oder Leerzeichen bestehen, bitte verwenden Sie Buchstaben, Zahlen, Unterstriche oder Bindestriche',
	...
	'otaManagement.confirmBatchDelete':
		'Sind Sie sicher, dass Sie die ausgewählten {paramCount} Firmware löschen möchten?',
	...
	'agentTemplateManagement.confirmBatchDelete':
		'Sind Sie sicher, dass Sie die ausgewählten {count} Vorlagen löschen möchten?',
	...
	'agentTemplateManagement.deleteBackendError':
		'Löschen fehlgeschlagen, bitte prüfen Sie, ob der Backend-Service normal ist',
	...
	'voiceClone.uploadTip':
		'Unterstützt alle gängigen Audioformate, ausgewählte Dauer muss zwischen 8-60 Sekunden liegen',
	'voiceClone.editTip1': 'Bitte bestätigen Sie, ob das hochgeladene Audio zufriedenstellend ist',
	'voiceClone.editTip2':
		'Sie können das Audio anhören und zuschneiden, wenn nicht zufrieden können Sie zurückgehen, um erneut aufzunehmen oder hochzuladen',
	...
	'knowledgeBaseManagement.confirmBatchDelete':
		'Sind Sie sicher, dass Sie die ausgewählten {count} Wissensbasen löschen möchten?',
	...
	'knowledgeBaseDialog.namePlaceholder':
		'Bitte Wissensbasis-Namen genau eingeben, um die Genauigkeit des Wissensbasis-Aufrufs zu verbessern',
	'knowledgeBaseDialog.description': 'Wissensbasis-Beschreibung',
	'knowledgeBaseDialog.descriptionPlaceholder':
		'Bitte Wissensbasis-Beschreibung genau eingeben, um dem Modell zu helfen, den Wissensbasis-Inhalt besser zu verstehen',
	...
	'knowledgeBaseDialog.namePattern':
		'Wissensbasis-Name darf nur Chinesisch, Englisch, Zahlen, Leerzeichen, Unterstriche und Bindestriche enthalten',
	...
	'knowledgeFileUpload.uploadTip':
		'Unterstützte Dateitypen: PDF, DOC, DOCX, TXT, MD, CSV, XLS, XLSX, PPT, PPTX. Maximal 32 Dateien pro Upload, jede Dateigröße bis zu 10MB',
	...
	'knowledgeFileUpload.confirmBatchDelete':
		'Sind Sie sicher, dass Sie die ausgewählten {count} Dateien löschen möchten?',
	...
	'feature.voiceprintRecognition.description':
		'Benutzeridentität durch Stimmerkennungstechnologie verifizieren, bietet sichere Sprachiinteraktion',
	'feature.voiceClone.name': 'Stimmenklon',
	'feature.voiceClone.description':
		'Spezifische Stimmfarbe mit KI-Technologie klonen, um personalisierte Sprachsynthese zu ermöglichen',
	'feature.knowledgeBase.name': 'Wissensbasis',
	'feature.knowledgeBase.description':
		'Wissensbasissystem aufbauen und verwalten, um professionelle Wissensunterstützung für KI-Assistenten zu bieten',
	'feature.mcpAccessPoint.name': 'MCP-Zugangspunkt',
	'feature.mcpAccessPoint.description':
		'MCP-Protokoll-Zugangspunkte bereitstellen, um Integration externer Tools und Dienste zu unterstützen',
	'feature.vad.name': 'Sprachaktivitätserkennung',
	'feature.vad.description':
		'Sprachaktivität automatisch erkennen, um die Effizienz der Sprachiinteraktion zu optimieren',

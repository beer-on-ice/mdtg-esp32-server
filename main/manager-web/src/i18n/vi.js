export default {
	...
	'mcpToolCall.help.getDeviceStatus':
		'Xem trạng thái hoạt động hiện tại của thiết bị, bao gồm âm lượng, màn hình, pin và các thông tin khác.',
	...
	'mcpToolCall.help.setTheme':
		'Chuyển đổi chủ đề hiển thị của màn hình thiết bị, bạn có thể chọn chế độ sáng hoặc tối.',
	'mcpToolCall.help.takePhoto':
		'Chụp ảnh bằng camera thiết bị và thực hiện phân tích nhận dạng, vui lòng nhập câu hỏi bạn muốn hỏi.',
	'mcpToolCall.help.getSystemInfo':
		'Lấy thông tin hệ thống của thiết bị, bao gồm thông số kỹ thuật phần cứng, phiên bản phần mềm, v.v.',
	...
	'mcpToolCall.help.upgradeFirmware':
		'Tải xuống và nâng cấp firmware thiết bị từ URL được chỉ định, thiết bị sẽ tự động khởi động lại sau khi nâng cấp.',
	'mcpToolCall.help.getScreenInfo':
		'Lấy thông tin chi tiết về màn hình, như độ phân giải, kích thước và các thông số khác.',
	...
	'cache.swCheckMethod1':
		'Kiểm tra trạng thái Service Worker trong tab Application/Application của công cụ nhà phát triển',
	...
	'cache.swCheckMethod3':
		'Sử dụng bản dựng production (npm run build) và truy cập qua máy chủ HTTP để kiểm tra chức năng đầy đủ',
	...
	'cache.swNotSupported':
		'Trình duyệt hiện tại không hỗ trợ Service Worker, chức năng cache tài nguyên CDN không khả dụng',
	...
	'cache.noCachedResourcesDesc':
		'Service Worker có thể chưa hoàn tất khởi tạo hoặc cache chưa được thiết lập. Vui lòng làm mới trang hoặc thử lại sau.',
	...
	'user.resetPasswordSuccess':
		'Mật khẩu đã được đặt lại, vui lòng thông báo cho người dùng đăng nhập bằng mật khẩu mới',
	...
	'modelConfigDialog.invalidModelId':
		'ID mô hình không thể chỉ là văn bản thuần túy hoặc khoảng trắng, vui lòng sử dụng chữ cái, số, dấu gạch dưới hoặc dấu gạch ngang',
	...
	'agentTemplateManagement.deleteBackendError':
		'Xóa thất bại, vui lòng kiểm tra xem dịch vụ backend có bình thường không',
	...
	'voiceClone.editTip2':
		'Bạn có thể nghe và cắt âm thanh, nếu không hài lòng có thể quay lại để ghi âm lại hoặc tải lên lại',
	...
	'knowledgeBaseDialog.namePlaceholder':
		'Vui lòng nhập chính xác tên cơ sở kiến thức để cải thiện độ chính xác của việc gọi cơ sở kiến thức',
	'knowledgeBaseDialog.description': 'Mô tả cơ sở kiến thức',
	'knowledgeBaseDialog.descriptionPlaceholder':
		'Vui lòng nhập chính xác mô tả cơ sở kiến thức để giúp mô hình hiểu rõ hơn nội dung cơ sở kiến thức',
	...
	'knowledgeBaseDialog.namePattern':
		'Tên cơ sở kiến thức chỉ có thể chứa chữ Trung, Anh, số, khoảng trắng, gạch dưới và gạch ngang',
	...
	'knowledgeFileUpload.uploadTip':
		'Các loại tệp được hỗ trợ: PDF, DOC, DOCX, TXT, MD, CSV, XLS, XLSX, PPT, PPTX. Tối đa 32 tệp mỗi lần tải lên, kích thước mỗi tệp lên đến 10MB',
	...
	'feature.voiceprintRecognition.description':
		'Xác minh danh tính người dùng thông qua công nghệ nhận dạng giọng nói, cung cấp trải nghiệm tương tác giọng nói an toàn',
	'feature.voiceClone.name': 'Nhân bản âm sắc',
	'feature.voiceClone.description':
		'Sử dụng công nghệ AI để nhân bản âm sắc cụ thể, đạt được tổng hợp giọng nói cá nhân hóa',
	'feature.knowledgeBase.name': 'Cơ sở kiến thức',
	'feature.knowledgeBase.description':
		'Xây dựng và quản lý hệ thống cơ sở kiến thức, cung cấp hỗ trợ kiến thức chuyên môn cho trợ lý AI',
	'feature.mcpAccessPoint.name': 'Điểm truy cập MCP',
	'feature.mcpAccessPoint.description':
		'Cung cấp điểm truy cập giao thức MCP, hỗ trợ tích hợp các công cụ và dịch vụ bên ngoài',

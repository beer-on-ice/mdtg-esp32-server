export default {
	...
	'mcpToolCall.help.getDeviceStatus':
		'View the current running status of the device, including volume, screen, battery and other information.',
	...
	'mcpToolCall.help.takePhoto':
		'Take photos with the device camera and perform recognition analysis, please enter the question you want to ask.',
	'mcpToolCall.help.getSystemInfo':
		'Get the system information of the device, including hardware specifications, software version, etc.',
	'mcpToolCall.help.reboot': 'Reboot the device, the device will restart after execution.',
	'mcpToolCall.help.upgradeFirmware':
		'Download and upgrade the device firmware from the specified URL, the device will restart automatically after the upgrade.',
	'mcpToolCall.help.getScreenInfo':
		'Get detailed information about the screen, such as resolution, size and other parameters.',
	...
	'cache.swCheckMethod3':
		'Use production build (npm run build) and access through HTTP server to test full functionality',
	...
	'cache.swNotSupported':
		'The current browser does not support Service Worker, CDN resource caching function is unavailable',
	...
	'cache.noCachedResourcesDesc':
		'Service Worker may not have completed initialization or cache has not been established. Please refresh the page or try again later.',
	...
	'roleConfig.restartNotice':
		'After saving the configuration, you need to restart the device for the new configuration to take effect.',
	...
	'modelConfigDialog.invalidModelId':
		'Model ID cannot be pure text or spaces, please use letters, numbers, underscores, or hyphens',
	...
	'knowledgeBaseDialog.namePlaceholder':
		'Please enter knowledge base name accurately to improve the accuracy of knowledge base call',
	'knowledgeBaseDialog.description': 'Knowledge Base Description',
	'knowledgeBaseDialog.descriptionPlaceholder':
		'Please enter knowledge base description accurately to help the model better understand the knowledge base content',
	...
	'knowledgeBaseDialog.namePattern':
		'Knowledge base name can only contain Chinese, English, numbers, spaces, underscores and hyphens',
	...
	'knowledgeFileUpload.uploadTip':
		'Supported file types: PDF, DOC, DOCX, TXT, MD, CSV, XLS, XLSX, PPT, PPTX. Maximum 32 files per upload, each file size up to 10MB',
	...
	'feature.voiceprintRecognition.description':
		'Verify user identity through voiceprint recognition technology, providing secure voice interaction experience',
	'feature.voiceClone.name': 'Voice Clone',
	'feature.voiceClone.description':
		'Clone specific voice timbre using AI technology to achieve personalized voice synthesis',
	'feature.knowledgeBase.name': 'Knowledge Base',
	'feature.knowledgeBase.description':
		'Build and manage knowledge base system to provide professional knowledge support for AI assistants',
	'feature.mcpAccessPoint.name': 'MCP Access Point',
	'feature.mcpAccessPoint.description':
		'Provide MCP protocol access points to support integration of external tools and services',

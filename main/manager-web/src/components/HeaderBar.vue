		...
		<div class="header-container">
			...
			<div class="header-center">
				<div
					...
					:class="{
						'active-tab':
							$route.path === '/home' || $route.path === '/role-config' || $route.path === '/device-management'
					}"
					@click="goHome"
				>
					<img
				...
				>
					<img
						...
						:style="{
							filter: $route.path === '/voice-clone-management' ? 'brightness(0) invert(1)' : 'None'
						}"
					/>
				...
				>
					<span class="el-dropdown-link">
						<img
							...
							:style="{
								filter:
									$route.path === '/voice-clone-management' || $route.path === '/voice-resource-management'
										? 'brightness(0) invert(1)'
										: 'None'
							}"
						/>
				...
				>
					<img
						...
						:style="{
							filter: $route.path === '/model-config' ? 'brightness(0) invert(1)' : 'None'
						}"
					/>
				...
				<div
					...
					class="equipment-management"
					:class="{
						'active-tab': $route.path === '/knowledge-base-management' || $route.path === '/knowledge-file-upload'
					}"
				...
				>
					<img
						...
						:style="{
							filter:
								$route.path === '/knowledge-base-management' || $route.path === '/knowledge-file-upload'
									? 'brightness(0) invert(1)'
									: 'None'
						}"
					/>
...
export default {
	...
	computed: {
		...
		// 根据当前语言获取对应的xiaomai-ai图标
		xiaomaiAiIcon() {
			const currentLang = this.currentLanguage
			switch (currentLang) {
				case 'zh_CN':
					return require('@/assets/xiaomai-ai.png')
				case 'zh_TW':
					return require('@/assets/xiaomai-ai_zh_TW.png')
				case 'en':
					return require('@/assets/xiaomai-ai_en.png')
				case 'de':
					return require('@/assets/xiaomai-ai_de.png')
				case 'vi':
					return require('@/assets/xiaomai-ai_vi.png')
				default:
					return require('@/assets/xiaomai-ai.png')
			}
		},
